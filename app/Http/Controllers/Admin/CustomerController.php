...
class CustomerController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse { $data=$this->validated($request);$customer=Customer::create($data);app(AccountService::class)->ensureCustomerHead($customer);return to_route('admin.customers.index')->with('success','Customer created successfully with an accounts receivable ledger head.'); }
