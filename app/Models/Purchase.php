...
{
    protected $fillable = ['purchase_number','warehouse_id','supplier_id','supplier_name','supplier_phone','invoice_number','purchase_date','status','subtotal','discount','tax','total','notes'];
